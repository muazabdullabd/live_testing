...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[437], {
    4446: function(t, e, i) {
        ...
        function h({children: t, isPresent: e}) {
            ...
            n.useInsertionEffect)( () => {
                let {width: t, height: s, top: n, left: a} = o.current;
                if (e || !r.current || !t || !s)
                    return;
        ...
        let u = ({children: t, initial: e, isPresent: i, onExitComplete: a, custom: l, presenceAffectsLayout: u, mode: c}) => {
            let p = (0,
            o.h)(d)
              , m = (0,
            n.useId)()
        ...
        var v = i(9033);
        let g = ({children: t, exitBeforeEnter: e, custom: i, initial: r=!0, onExitComplete: a, presenceAffectsLayout: l=!0, mode: h="sync"}) => {
            (0,
    ...
    4635: function(t, e, i) {
        ...
        var n, r = i(7437), o = i(2265), a = i(9791);
        let l = (0,
        o.createContext)({});
        var h = i(7797)
          , u = i(9033);
        ...
        o.createContext)({
          ...
          , f = ["read", "resolveKeyframes", "update", "preRender", "render", "postRender"];
        function v(t, e) {
            let i = !1
              , s = !0
              , n = {
            ...
            t), {})
              ...
              , p = () => {
                let r = m.useManualTiming ? n.timestamp : performance.now();
                i = !1,
            ...
            ;
            return {
                schedule: f.reduce( (t, e) => {
                    let s = o[e];
                    return t[e] = (t, e=!1, n=!1) => (i || v(),
                    s.schedule(t, e, n)),
                    t
                }
                , {}),
        ...
        let {schedule: g, cancel: y} = v(queueMicrotask, !1);
        function x(t) {
        ...
        let A = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"]
          , V = ["initial", ...A];
        function C(t) {
            return S(t.animate) || V.some(e => b(t[e]))
        }
        function E(t) {
        ...
        function B(t) {
            if ("string" != typeof t || t.includes("-"))
                ;
            else if (F.indexOf(t) > -1 || /[A-Z]/u.test(t))
                return !0;
            return !1
        }
        let O = {}
          , U = ["transformPerspective", "x", "y", "z", "translateX", "translateY", "translateZ", "scale", "scaleX", "scaleY", "rotate", "rotateX", "rotateY", "rotateZ", "skew", "skewX", "skewY"]
          , I = new Set(U);
        function $(t, {layout: e, layoutId: i}) {
            return I.has(t) || t.startsWith("origin") || (e || void 0 !== i) && (!!O[t] || "opacity" === t)
        }
        let W = t => !!(t && t.getVelocity)
          ...
          , H = K("--")
          , Y = K("var(--")
          , Z = t => !!Y(t) && X.test(t.split("/*")[0].trim())
          , X = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu
          , G = (t, e) => e && "number" == typeof t ? e.transform(t) : t
          ...
          , ts = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu;
        function tn(t) {
        ...
        function tm(t, e, i) {
            ...
            if (!e.transform && (a || i ? s.transform = function(t, e, i) {
                ...
                s
            }(t.transform, h, i) : s.transform && (s.transform = "none")),
            l) {
        ...
        let tx = t => !ty(t);
        try {
            (n = require("@emotion/is-prop-valid").default) && (tx = t => t.startsWith("on") ? !ty(t) : n(t))
        } catch (t) {}
        function tP(t, e, i) {
        ...
        function tb(t, {attrX: e, attrY: i, attrScale: s, originX: n, originY: r, pathLength: o, pathSpacing: a=1, pathOffset: l=0, ...h}, u, d) {
            if (tm(t, h, d),
            u) {
        ...
        function tV(t, {style: e, vars: i}, s, n) {
        ...
        function tE(t, e, i, s) {
            for (let i in tV(t, e, void 0, s),
            e.attrs)
                t.setAttribute(tC.has(i) ? i : c(i), e.attrs[i])
        }
        function tM(t, e, i) {
            var s;
            let {style: n} = t
              , r = {};
            for (let o in n)
                (W(n[o]) || e.style && W(e.style[o]) || $(o, t) || (null === (s = null == i ? void 0 : i.getValue(o)) || void 0 === s ? void 0 : s.liveStyle) !== void 0) && (r[o] = n[o]);
            return i && n && "string" == typeof n.willChange && (i.applyWillChange = !1),
            r
        }
        function tR(t, e, i) {
            let s = tM(t, e, i);
            for (let i in t)
                (W(t[i]) || W(e[i])) && (s[-1 !== U.indexOf(i) ? "attr" + i.charAt(0).toUpperCase() + i.substring(1) : i] = t[i]);
            return s
        }
        function tk(t) {
            let e = [{}, {}];
        ...
        function tI(t) {
            return I.has(t) ? "transform" : tU.has(t) ? c(t) : void 0
        }
        function t$(t, e) {
        ...
        let tN = t => (e, i) => {
            ...
            o.useContext)(l)
              , n = (0,
            o.useContext)(h.O)
              , r = () => (function({applyWillChange: t=!1, scrapeMotionValuesFromProps: e, createRenderState: i, onMount: s}, n, r, o, a) {
                let l = {
                    latestValues: function(t, e, i, s, n) {
                        var r;
                        let o = {}
                          , a = []
                          , l = s && (null === (r = t.style) || void 0 === r ? void 0 : r.willChange) === void 0
                          , h = n(t, {});
                        for (let t in h)
                            o[t] = tO(h[t]);
                        let {initial: u, animate: d} = t
                          , c = C(t)
                          , p = E(t);
                        e && p && !c && !1 !== t.inherit && (void 0 === u && (u = e.initial),
                        void 0 === d && (d = e.animate));
                        let m = !!i && !1 === i.initial
                          , f = (m = m || !1 === u) ? d : u;
                        return f && "boolean" != typeof f && !S(f) && tz(t, f, (t, e) => {
                            for (let e in t) {
                                let i = t[e];
                                if (Array.isArray(i)) {
        ...
        var tK = i(9276);
        let {schedule: tH, cancel: tY, state: tZ, steps: tX} = v("undefined" != typeof requestAnimationFrame ? requestAnimationFrame : tK.Z, !0)
          , tG = {
            useVisualState: tN({
                ...
                onMount: (t, e, {renderState: i, latestValues: s}) => {
                    ...
                    tH.render( () => {
                        tb(i, s, tA(e.tagName), t.transformTemplate),
                        tE(e, i)
                    }
                    )
                }
        ...
        function et(t, e) {
            ...
            return t1(t.current, e ? "pointerenter" : "pointerleave", (s, n) => {
                if ("touch" === s.pointerType || t6())
                    return;
                let r = t.getProps();
                t.animationState && r.whileHover && t.animationState.setActive("whileHover", e);
                let o = r[i];
                o && tH.postRender( () => o(s, n))
            }
            , {
        ...
        class ei extends t8 {
            ...
            mount() {
                this.unmount = t2(t_(this.node.current, "focus", () => this.onFocus()), t_(this.node.current, "blur", () => this.onBlur()))
            }
            unmount() {}
        }
        ...
        class er extends t8 {
            constructor() {
                super(...arguments),
                this.removeStartListeners = tK.Z,
                this.removeEndListeners = tK.Z,
                this.removeAccessibleListeners = tK.Z,
                this.startPointerPress = (t, e) => {
                    if (this.isPressing)
                        return;
                    this.removeEndListeners();
                    let i = this.node.getProps()
                      , s = t1(window, "pointerup", (t, e) => {
                    ...
                    , {
                      ...
                      , n = t1(window, "pointercancel", (t, e) => this.cancelPress(t, e), {
                        passive: !(i.onTapCancel || i.onPointerCancel)
                    });
                    this.removeEndListeners = t2(s, n),
                    this.startPress(t, e)
                }
                ,
                this.startAccessiblePress = () => {
                    let t = t_(this.node.current, "keydown", t => {
                        "Enter" !== t.key || this.isPressing || (this.removeEndListeners(),
                        this.removeEndListeners = t_(this.node.current, "keyup", t => {
                            "Enter" === t.key && this.checkPressEnd() && en("up", (t, e) => {
                                let {onTap: i} = this.node.getProps();
                                i && tH.postRender( () => i(t, e))
                            }
                            )
                        }
                        ),
            ...
            mount() {
                let t = this.node.getProps()
                  ...
                  , i = t_(this.node.current, "focus", this.startAccessiblePress);
            ...
            startObserver() {
                ...
                return function(t, e, i) {
                    let s = function({root: t, ...e}) {
                        ...
                        let s = ea.get(i)
                          , n = JSON.stringify(e);
                        return s[n] || (s[n] = new IntersectionObserver(eh,{
                            root: t,
                            ...e
                        })),
                        s[n]
        ...
        function ep(t, e, i) {
            let s = t.getProps();
            return tD(s, e, void 0 !== i ? i : s.custom, t)
        }
        let em = t => 1e3 * t
          , ef = t => t / 1e3
          , ev = {
          ...
          , eP = (t, {keyframes: e}) => e.length > 2 ? ey : I.has(t) ? t.startsWith("scale") ? eg(e[1]) : ev : ex;
        function ew(t, e) {
        ...
        let eV = {
            now: () => (void 0 === s && eV.set(tZ.isProcessing || m.useManualTiming ? tZ.timestamp : performance.now()),
            s),
            set: t => {
                s = t,
                queueMicrotask(eA)
        ...
        let eM = t => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t)
          ...
          , ek = new Set(["width", "height", "top", "left", "right", "bottom", "x", "y", "translateX", "translateY"])
          , eD = t => t === _ || t === tl
          , ej = (t, e) => parseFloat(t.split(", ")[e])
          , eL = (t, e) => (i, {transform: s}) => {
            if ("none" === s || !s)
                return 0;
        ...
        function eK() {
            if (ez) {
                let t = Array.from(eW).filter(t => t.needsMeasurement)
            ...
            ez = !1,
            eN = !1,
            eW.forEach(t => t.complete()),
            eW.clear()
        }
        function eH() {
            eW.forEach(t => {
                t.readKeyframes(),
                t.needsMeasurement && (ez = !0)
            }
            )
        }
        class eY {
            ...
            scheduleResolve() {
                this.isScheduled = !0,
                this.isAsync ? (eW.add(this),
                eN || (eN = !0,
                tH.read(eH),
                tH.resolveKeyframes(eK))) : (this.readKeyframes(),
                this.complete())
            }
            readKeyframes() {
        ...
        let eZ = (t, e) => i => !!(tn(i) && ts.test(i) && i.startsWith(t) || e && null != i && Object.prototype.hasOwnProperty.call(i, e))
          , eX = (t, e, i) => s => {
            if (!tn(s))
                return s;
          ...
          , e_ = {
            ...
            transform: ({red: t, green: e, blue: i, alpha: s=1}) => "rgba(" + eq.transform(t) + ", " + eq.transform(e) + ", " + eq.transform(i) + ", " + tt(J.transform(s)) + ")"
        }
          , eJ = {
            test: eZ("#"),
            parse: function(t) {
          ...
          , eQ = {
            ...
            transform: ({hue: t, saturation: e, lightness: i, alpha: s=1}) => "hsla(" + Math.round(t) + ", " + ta.transform(tt(e)) + ", " + ta.transform(tt(i)) + ", " + tt(J.transform(s)) + ")"
        }
          , e0 = {
            test: t => e_.test(t) || eJ.test(t) || eQ.test(t),
            parse: t => e_.test(t) ? e_.parse(t) : eQ.test(t) ? eQ.parse(t) : eJ.parse(t),
            transform: t => tn(t) ? t : t.hasOwnProperty("red") ? e_.transform(t) : eQ.transform(t)
        }
          , e1 = "number"
          , e5 = "color"
        ...
        function e3(t) {
            let e = t.toString()
              ...
              , n = []
              , r = 0
              , o = e.replace(e2, t => (e0.test(t) ? (s.color.push(r),
            n.push(e5),
            i.push(e0.parse(t))) : t.startsWith("var(") ? (s.var.push(r),
            n.push("var"),
        ...
        function e7(t) {
            ...
            return t => {
                ...
                for (let r = 0; r < s; r++)
                    ...
                    void 0 !== t[r]) {
                        let e = i[r];
                        e === e1 ? n += tt(t[r]) : e === e5 ? n += e0.transform(t[r]) : n += t[r]
                    }
                return n
            }
        }
        let e4 = t => "number" == typeof t ? 0 : t
          , e6 = {
            test: function(t) {
                var e, i;
                return isNaN(t) && tn(t) && ((null === (e = t.match(te)) || void 0 === e ? void 0 : e.length) || 0) + ((null === (i = t.match(ti)) || void 0 === i ? void 0 : i.length) || 0) > 0
            },
            parse: e9,
            createTransformer: e7,
            getAnimatableNone: function(t) {
                let e = e9(t);
                return e7(t)(e.map(e4))
            }
        }
        ...
        class il extends eY {
                ...
                for (let i = 0; i < t.length; i++) {
                    ...
                    if ("string" == typeof s && Z(s = s.trim())) {
                        let n = function t(e, i, s=1) {
                            (0,
                            eE.k)(s <= 4, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`);
                            let[n,r] = function(t) {
                                let e = eR.exec(t);
                                if (!e)
                                    return [, ];
            ...
            resolveNoneKeyframes() {
                ...
                for (let e = 0; e < t.length; e++) {
                    var s;
                    ("number" == typeof (s = t[e]) ? 0 === s : null === s || "none" === s || "0" === s || eC(s)) && i.push(e)
                }
                i.length && function(t, e, i) {
                    let s, n = 0;
                    for (; n < t.length && !s; ) {
                        let e = t[n];
                        "string" == typeof e && !ia.has(e) && e3(e).values.length && (s = t[n]),
                        n++
                    }
                    if (s && i)
                        for (let n of e)
            ...
            measureInitialState() {
                ...
                this.measuredOrigin = eO[i](t.measureViewportBox(), window.getComputedStyle(t.current)),
            ...
            measureEndState() {
                ...
                let r = s.length - 1
                  , o = s[r];
                s[r] = eO[i](e.measureViewportBox(), window.getComputedStyle(e.current)),
        ...
        let iu = (t, e) => "zIndex" !== e && !!("number" == typeof t || Array.isArray(t) || "string" == typeof t && (e6.test(t) || "0" === t) && !t.startsWith("url("));
        class id {
            ...
            get resolved() {
                return this._resolved || this.hasAttemptedResolve || (eH(),
                eK()),
                this._resolved
            }
            onKeyframesResolved(t, e) {
                ...
                if (!l && !function(t, e, i, s) {
                    ...
                    let r = t[t.length - 1]
                      ...
                      , a = iu(r, e);
                    return (0,
                    eE.K)(o === a, `You are trying to animate ${e} from "${n}" to "${r}". ${n} is not an animatable value - to enable this animation set ${n} to a value animatable to ${r} via the \`style\` property.`),
                    !!o && !!a && (function(t) {
                        let e = t[0];
                        if (1 === t.length)
                            return !0;
        ...
        function iy({keyframes: t, restDelta: e, restSpeed: i, ...s}) {
            let n;
            let r = t[0]
              , o = t[t.length - 1]
              , a = {
              ...
              , {stiffness: l, damping: h, mass: u, duration: d, velocity: c, isResolvedFromDuration: p} = function(t) {
                ...
                if (!ig(t, iv) && ig(t, im)) {
                    let i = function({duration: t=800, bounce: e=.25, velocity: i=0, mass: s=1}) {
                        let n, r;
                        (0,
                        eE.K)(t <= em(10), "Spring duration must be 10 seconds or less");
                        let o = 1 - e;
                        o = q(.05, 1, o),
                        t = q(.01, 10, ef(t)),
                        o < 1 ? (n = e => {
                            let s = e * o
                              , n = s * t;
                            return .001 - (s - i) / ip(e, o) * Math.exp(-n)
                        }
                        ,
                        r = e => {
                            let s = e * o * t
        ...
        function ix({keyframes: t, velocity: e=0, power: i=.8, timeConstant: s=325, bounceDamping: n=10, bounceStiffness: r=500, modifyTarget: o, min: a, max: l, restDelta: h=.5, restSpeed: u}) {
            let d, c;
            let p = t[0]
              , m = {
                done: !1,
        ...
        let iP = (t, e, i) => (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
        function iw(t, e, i, s) {
            if (t === e && i === s)
                return tK.Z;
            let n = e => (function(t, e, i, s, n) {
                ...
                let a = 0;
                do
                    (r = iP(o = e + (i - e) / 2, s, n) - t) > 0 ? i = o : e = o;
                while (Math.abs(r) > 1e-7 && ++a < 12);
                return o
            }
            )(e, 0, 1, t, i);
            return t => 0 === t || 1 === t ? t : iP(n(t), e, s)
        }
        let iT = iw(.42, 0, 1, 1)
          , ib = iw(0, 0, .58, 1)
          , iS = iw(.42, 0, .58, 1)
          , iA = t => Array.isArray(t) && "number" != typeof t[0]
          , iV = t => e => e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2
          , iC = t => e => 1 - t(1 - e)
          , iE = t => 1 - Math.sin(Math.acos(t))
          , iM = iC(iE)
          , iR = iV(iE)
          , ik = iw(.33, 1.53, .69, .99)
          , iD = iC(ik)
          ...
          , iF = t => {
            if (Array.isArray(t)) {
                (0,
                eE.k)(4 === t.length, "Cubic bezier arrays must contain four numerical values.");
                let[e,i,s,n] = t;
                return iw(e, i, s, n)
            }
            return "string" == typeof t ? ((0,
            eE.k)(void 0 !== iL[t], `Invalid easing type '${t}'`),
            iL[t]) : t
        }
          , iB = (t, e, i) => {
            let s = e - t;
        ...
        let i$ = (t, e, i) => {
          ...
          , iW = [eJ, e_, eQ]
          , iN = t => iW.find(e => e.test(t));
        function iz(t) {
            let e = iN(t);
            if ((0,
            eE.K)(!!e, `'${t}' is not an animatable color. Use the equivalent color code instead.`),
            !e)
                return !1;
            let i = e.parse(t);
            return e === eQ && (i = function({hue: t, saturation: e, lightness: i, alpha: s}) {
                t /= 360,
                i /= 100;
                let n = 0
                  , r = 0
        ...
        let iK = (t, e) => {
            ...
            return t => (n.red = i$(i.red, s.red, t),
            n.green = i$(i.green, s.green, t),
            n.blue = i$(i.blue, s.blue, t),
            n.alpha = iO(i.alpha, s.alpha, t),
            e_.transform(n))
        }
        ...
        function iZ(t) {
            return "number" == typeof t ? iY : "string" == typeof t ? Z(t) ? iI : e0.test(t) ? iK : iq : Array.isArray(t) ? iX : "object" == typeof t ? e0.test(t) ? iK : iG : iI
        }
        function iX(t, e) {
            let i = [...t]
              , s = i.length
              , n = t.map( (t, i) => iZ(t)(t, e[i]));
            return t => {
                for (let e = 0; e < s; e++)
                    i[e] = n[e](t);
                return i
        ...
        function iG(t, e) {
            let i = {
              ...
              , s = {};
            for (let n in i)
                void 0 !== t[n] && void 0 !== e[n] && (s[n] = iZ(t[n])(t[n], e[n]));
            return t => {
                for (let e in s)
                    i[e] = s[e](t);
                return i
        ...
        let iq = (t, e) => {
            let i = e6.createTransformer(e)
              , s = e3(t)
              , n = e3(e);
            return s.indexes.var.length === n.indexes.var.length && s.indexes.color.length === n.indexes.color.length && s.indexes.number.length >= n.indexes.number.length ? iH.has(t) && !n.values.length || iH.has(e) && !s.values.length ? iH.has(t) ? i => i <= 0 ? t : e : i => i >= 1 ? e : t : t2(iX(function(t, e) {
                var i;
                let s = []
                  , n = {
                    color: 0,
            ...
            eE.K)(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`),
            iI(t, e))
        }
        ;
        function i_(t, e, i) {
            return "number" == typeof t && "number" == typeof e && "number" == typeof i ? iO(t, e, i) : iZ(t)(t, e)
        }
        function iJ({duration: t=300, keyframes: e, times: i, ease: s="easeInOut"}) {
            let n = iA(s) ? s.map(iF) : iF(s)
              , r = {
                done: !1,
                value: e[0]
            }
              , o = function(t, e, {clamp: i=!0, ease: s, mixer: n}={}) {
                let r = t.length;
                if ((0,
                eE.k)(r === e.length, "Both input and output ranges must be the same length"),
                1 === r)
                    return () => e[0];
                if (2 === r && t[0] === t[1])
                    return () => e[1];
                ...
                let o = function(t, e, i) {
                    ...
                    for (let i = 0; i < r; i++) {
                        let r = n(t[i], t[i + 1]);
                        e && (r = t2(Array.isArray(e) ? e[i] || tK.Z : e, r)),
                        s.push(r)
                    }
                    return s
                }(e, s, n)
                ...
                ease: Array.isArray(n) ? n : e.map( () => n || iS).splice(0, e.length - 1)
            });
            return {
        ...
        let iQ = t => {
            ...
            return {
                start: () => tH.update(e, !0),
                stop: () => tY(e),
                now: () => tZ.isProcessing ? tZ.timestamp : eV.now()
            }
        }
          , i0 = {
            decay: ix,
        ...
        class i5 extends id {
            constructor({KeyframeResolver: t=eY, ...e}) {
                ...
                i && s && s.owner ? this.resolver = s.owner.resolveKeyframes(n, r, i, s) : this.resolver = new t(n,r,i,s),
            ...
            initPlayback(t) {
                ...
                let {type: s="keyframes", repeat: n=0, repeatDelay: r=0, repeatType: o, velocity: a=0} = this.options
                  , l = i0[s] || iJ;
                l !== iJ && "number" != typeof t[0] && (e = t2(i1, i_(t[0], t[1])),
                t = [0, 100]);
                let h = l({
                    ...this.options,
                    keyframes: t
            ...
            tick(t, e=!1) {
                ...
                return T && void 0 !== s && (P.value = eS(a, this.options, s)),
                f && f(P.value),
                T && this.finish(),
                P
            }
            ...
            set speed(t) {
                ...
                e && (this.time = ef(this.currentTime))
            }
            play() {
                ...
                if (this.isStopped)
                    return;
                let {driver: t=iQ, onPlay: e} = this.options;
        ...
        let i2 = t => Array.isArray(t) && "number" == typeof t[0]
          , i3 = ([t,e,i,s]) => `cubic-bezier(${t}, ${e}, ${i}, ${s})`
          , i9 = {
            linear: "linear",
            ease: "ease",
            easeIn: "ease-in",
            ...
            circIn: i3([0, .65, .55, 1]),
            circOut: i3([.55, 0, 1, .45]),
            backIn: i3([.31, .01, .66, -.59]),
            backOut: i3([.33, 1.53, .69, .99])
        };
        function i7(t) {
            return i4(t) || i9.easeOut
        }
        function i4(t) {
            if (t)
                return i2(t) ? i3(t) : Array.isArray(t) ? t.map(i7) : i9[t]
        }
        let i6 = ih( () => Object.hasOwnProperty.call(Element.prototype, "animate"));
        class i8 extends id {
            constructor(t) {
                super(t);
                let {name: e, motionValue: i, keyframes: s} = this.options;
                this.resolver = new il(s, (t, e) => this.onKeyframesResolved(t, e),e,i),
                this.resolver.scheduleResolve()
            }
            initPlayback(t, e) {
                var i, s;
                let {duration: n=300, times: r, ease: o, type: a, motionValue: l, name: h} = this.options;
                if (!(null === (i = l.owner) || void 0 === i ? void 0 : i.current))
                    return !1;
                if ("spring" === (s = this.options).type || !function t(e) {
                    return !!(!e || "string" == typeof e && e in i9 || i2(e) || Array.isArray(e) && e.every(t))
                }(s.ease)) {
                    let {onComplete: e, onUpdate: i, motionValue: s, ...l} = this.options
                      , h = function(t, e) {
                        let i = new i5({
                            ...e,
                            keyframes: t,
                ...
                let u = function(t, e, i, {delay: s=0, duration: n=300, repeat: r=0, repeatType: o="loop", ease: a, times: l}={}) {
                    let h = {
                        [e]: i
                    };
                    l && (h.offset = l);
            ...
            static supports(t) {
                ...
                return i6() && i && tU.has(i) && e && e.owner && e.owner.current instanceof HTMLElement && !e.owner.getProps().onUpdate && !s && "mirror" !== n && 0 !== r && "inertia" !== o
            }
        }
        let st = ih( () => void 0 !== window.ScrollTimeline);
        class se {
            constructor(t) {
        ...
        let si = (t, e, i, s={}, n, r, o) => a => {
            ...
            0 !== d.delay || (c = !0)),
            (eT.current || m.skipAnimations) && (c = !0,
            d.duration = 0,
            d.delay = 0),
            c && !r && void 0 !== e.get()) {
            ...
            return !r && i8.supports(d) ? new i8(d) : new i5(d)
        }
        ;
        class ss {
            constructor() {
        ...
        class so {
            ...
            setCurrent(t) {
                ...
                null === this.canTrackVelocity && void 0 !== t && (this.canTrackVelocity = sn(this.current))
            }
            ...
            on(t, e) {
                this.events[t] || (this.events[t] = new ss);
            ...
            get() {
                return sr.current && sr.current.push(this),
                this.current
            }
            getPrevious() {
                return this.prev
        ...
        function su(t, e) {
            ...
            if (n || (null === (i = t.props.style) || void 0 === i ? void 0 : i.willChange) || (n = new sh("auto"),
            t.addValue("willChange", n)),
            W(s = n) && s.add)
                return n.add(e)
        }
        function sd(t, e, {delay: i=0, transitionOverride: s, type: n}={}) {
            var r;
            ...
            for (let e in l) {
                let s = t.getValue(e, null !== (r = t.latestValues[e]) && void 0 !== r ? r : null)
                  , n = l[e];
                if (void 0 === n || u && function({protectedKeys: t, needsAnimating: e}, i) {
                ...
                if (window.HandoffAppearAnimations) {
                    let i = sl(t);
                    if (i) {
                        let t = window.HandoffAppearAnimations(i, e, s, tH);
                        null !== t && (a.elapsed = t,
                        d = !0)
                    }
                }
                s.start(si(e, s, n, t.shouldReduceMotion && I.has(e) ? {
                    type: !1
                } : a, t, d, su(t, e)));
                let c = s.animation;
                c && h.push(c)
            ...
            return a && Promise.all(h).then( () => {
                tH.update( () => {
                    a && function(t, e) {
                        let {transitionEnd: i={}, transition: s={}, ...n} = ep(t, e) || {};
                        for (let e in n = {
                            ...n,
                            ...i
                        }) {
                            let i = tB(n[e]);
                            t.hasValue(e) ? t.getValue(e).set(i) : t.addValue(e, sa(i))
                        }
                    }(t, a)
                }
                )
        ...
        function sc(t, e, i={}) {
            var s;
            let n = ep(t, e, "exit" === i.type ? null === (s = t.presenceContext) || void 0 === s ? void 0 : s.custom : void 0)
              , {transition: r=t.getDefaultTransition() || {}} = n || {};
            i.transitionOverride && (r = i.transitionOverride);
            let o = n ? () => Promise.all(sd(t, n, i)) : () => Promise.resolve()
              , a = t.variantChildren && t.variantChildren.size ? (s=0) => {
                ...
                return function(t, e, i=0, s=0, n=1, r) {
                    ...
                    return Array.from(t.variantChildren).sort(sp).forEach( (t, s) => {
                ...
                t.animationState || (t.animationState = function(t) {
                    let e = e => Promise.all(e.map( ({animation: e, options: i}) => (function(t, e, i={}) {
                        ...
                        Array.isArray(e))
                            ...
                            let n = "function" == typeof e ? ep(t, e, i.custom) : e;
                            s = Promise.all(sd(t, n, i))
                        }
                        return s.then( () => {
                      ...
                      , n = e => (i, s) => {
                        var n;
                        let r = ep(t, s, "exit" === e ? null === (n = t.presenceContext) || void 0 === n ? void 0 : n.custom : void 0);
                        if (r) {
                    ...
                    function r(r) {
                        ...
                        for (let e = 0; e < sf; e++) {
                            ...
                            !m.isActive && null === g || !f && !m.prevProp || S(f) || "boolean" == typeof f)
                                continue;
                            let x = (c = m.prevProp,
                            ("string" == typeof f ? f !== c : !!Array.isArray(f) && !ec(f, c)) || p === r && m.isActive && !y && v || e > d && v)
                              , P = !1
                            ...
                            for (let t in V) {
                                ...
                                if (!u.hasOwnProperty(t))
                                    (tL(e) && tL(i) ? ec(e, i) : e === i) ? void 0 !== e && h.has(t) ? C(t) : m.protectedKeys[t] = !0 : null != e ? C(t) : h.add(t)
                            }
                            m.prevProp = f,
                        ...
                        let p = !!l.length;
                        return s && (!1 === o.initial || o.initial === o.animate) && !t.manuallyAnimateOnMount && (p = !1),
                        s = !1,
            ...
            constructor(t, e, {transformPagePoint: i, contextWindow: s, dragSnapToOrigin: n=!1}={}) {
                ...
                this.updatePoint = () => {
                    ...
                    if (!(this.lastMoveEvent && this.lastMoveEventInfo))
                        return;
                    let i = sA(this.lastMoveEventInfo, this.history)
                    ...
                    Math.sqrt(sw(t.x, e.x) ** 2 + sw(t.y, e.y) ** 2) >= 3);
                    if (!s && !n)
                        return;
                    let {point: r} = i
                      , {timestamp: o} = tZ;
                ...
                this.handlePointerMove = (t, e) => {
                    ...
                    this.lastMoveEventInfo = sb(e, this.transformPagePoint),
                ...
                this.handlePointerUp = (t, e) => {
                    ...
                    !(this.lastMoveEvent && this.lastMoveEventInfo))
                        return;
                    let r = sA("pointercancel" === t.type ? this.lastMoveEventInfo : sb(e, this.transformPagePoint), this.history);
                ...
                let r = sb(tQ(t), this.transformPagePoint)
                  , {point: o} = r
                  , {timestamp: a} = tZ;
                this.history = [{
                    ...o,
                ...
                l && l(t, sA(r, this.history)),
                this.removeListeners = t2(t1(this.contextWindow, "pointermove", this.handlePointerMove), t1(this.contextWindow, "pointerup", this.handlePointerUp), t1(this.contextWindow, "pointercancel", this.handlePointerUp))
            }
            updateHandlers(t) {
                this.handlers = t
            }
        ...
        function sE(t, e, i, s=.5) {
            t.origin = s,
            t.originPoint = iO(e.min, e.max, t.origin),
            t.scale = sC(i) / sC(e),
            t.translate = iO(i.min, i.max, t.origin) - t.originPoint,
        ...
        function sN({top: t, left: e, right: i, bottom: s}) {
            return {
                x: {
                    min: e,
                    max: i
        ...
        function sK({scale: t, scaleX: e, scaleY: i}) {
            return !sz(t) || !sz(e) || !sz(i)
        }
        function sH(t) {
            return sK(t) || sY(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY
        }
        function sY(t) {
            var e, i;
            return (e = t.x) && "0%" !== e || (i = t.y) && "0%" !== i
        }
        function sZ(t, e, i, s, n) {
            return void 0 !== n && (t = s + n * (t - s)),
            s + i * (t - s) + e
        }
        function sX(t, e=0, i=1, s, n) {
            t.min = sZ(t.min, e, i, s, n),
            t.max = sZ(t.max, e, i, s, n)
        }
        function sG(t, {x: e, y: i}) {
            sX(t.x, e.translate, e.scale, e.originPoint),
            sX(t.y, i.translate, i.scale, i.originPoint)
        }
        function sq(t, e) {
            t.min = t.min + e,
            t.max = t.max + e
        }
        function s_(t, e, i, s, n=.5) {
            let r = iO(t.min, t.max, n);
            sX(t, e, i, r, s)
        }
        function sJ(t, e) {
            s_(t.x, e.x, e.scaleX, e.scale, e.originX),
            s_(t.y, e.y, e.scaleY, e.scale, e.originY)
        }
        function sQ(t, e) {
        ...
        let s0 = ({current: t}) => t ? t.ownerDocument.defaultView : null
          , s1 = new WeakMap;
        class s5 {
            constructor(t) {
            ...
            start(t, {snapToCursor: e=!1}={}) {
                ...
                this.panSession = new sT(t,{
                    ...
                    onStart: (t, e) => {
                        var i;
                        let {drag: s, dragPropagation: n, onDragStart: r} = this.getProps();
                        if (s && !n && (this.openGlobalLock && this.openGlobalLock(),
                        this.openGlobalLock = t4(s),
                        !this.openGlobalLock))
                            return;
                        this.isDragging = !0,
                        this.currentDirection = null,
                        ...
                        this.removeWillChange = su(this.visualElement, "transform");
            ...
            updateAxis(t, e, i) {
                ...
                if (!i || !s2(t, s, this.currentDirection))
                    return;
                let n = this.getAxisMotionValue(t)
                  , r = this.originPoint[t] + i[t];
                this.constraints && this.constraints[t] && (r = function(t, {min: e, max: i}, s) {
                    return void 0 !== e && t < e ? t = s ? iO(e, t, s.min) : Math.max(t, e) : void 0 !== i && t > i && (t = s ? iO(i, t, s.max) : Math.min(t, i)),
                    t
            ...
            resolveConstraints() {
                ...
                let {dragConstraints: e, dragElastic: i} = this.getProps()
                  ...
                  , n = this.constraints;
                e && x(e) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : e && s ? this.constraints = function(t, {top: e, left: i, bottom: s, right: n}) {
                    return {
                        x: sj(t.x, i, n),
                        y: sj(t.y, e, s)
                    }
                ...
                n !== this.constraints && s && this.constraints && !this.hasMutatedConstraints && sW(t => {
            ...
            resolveRefConstraints() {
                ...
                let s = e.current;
                (0,
                eE.k)(null !== s, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.");
                ...
                let r = function(t, e, i) {
                    let s = sQ(t, i)
                      , {scroll: n} = e;
                    return n && (sq(s.x, n.offset.x),
                    sq(s.y, n.offset.y)),
                    s
                }(s, n.root, this.visualElement.getTransformPagePoint())
                  , o = {
                    x: sL((t = n.layout.layoutBox).x, r.x),
                    y: sL(t.y, r.y)
                };
                if (i) {
            ...
            startAnimation(t) {
                let {drag: e, dragMomentum: i, dragElastic: s, dragTransition: n, dragSnapToOrigin: r, onDragTransitionEnd: o} = this.getProps()
                  , a = this.constraints || {};
                return Promise.all(sW(o => {
                    if (!s2(o, e, this.currentDirection))
                        return;
                    let l = a && a[o] || {};
                    r && (l = {
                        min: 0,
            ...
            startAxisValueAnimation(t, e) {
                ...
                return i.start(si(t, i, 0, e, this.visualElement, !1, su(this.visualElement, t)))
            }
            stopAnimation() {
            ...
            snapToCursor(t) {
                sW(e => {
                    ...
                    if (!s2(e, i, this.currentDirection))
                        return;
                    ...
                    if (e && !1 !== this.constraints) {
                        ...
                        s[t] = function(t, e) {
                            let i = .5
                              , s = sC(t)
                              , n = sC(e);
                            return n > s ? i = iB(e.min, e.max - s, t.min) : s > n && (i = iB(t.min, t.max - n, e.min)),
                            q(0, 1, i)
                        }({
                            min: i,
                            max: i
            ...
            addListeners() {
                ...
                i.updateLayout()),
                tH.read(e);
                let n = t_(window, "resize", () => this.scalePositionWithinConstraints())
                  , r = i.addEventListener("didUpdate", ({delta: t, hasLayoutChanged: e}) => {
                    this.isDragging && e && (sW(e => {
                        let i = this.getAxisMotionValue(e);
        ...
        class s3 extends t8 {
            constructor(t) {
                super(t),
                this.removeGroupControls = tK.Z,
                this.removeListeners = tK.Z,
                this.controls = new s5(t)
            }
            mount() {
                let {dragControls: t} = this.node.getProps();
                t && (this.removeGroupControls = t.subscribe(this.controls)),
                this.removeListeners = this.controls.addListeners() || tK.Z
            }
            unmount() {
        ...
        class s7 extends t8 {
            constructor() {
                super(...arguments),
                this.removePointerDownListener = tK.Z
            }
            onPointerDown(t) {
                this.session = new sT(t,this.createPanHandlers(),{
        ...
        class nt extends o.Component {
            ...
            getSnapshotBeforeUpdate(t) {
                ...
                t.isPresent === n || (n ? r.promote() : r.relegate() || tH.postRender( () => {
                    let t = r.getStack();
        ...
        let ni = {
          ...
          , no = t => "number" == typeof t || tl.test(t);
        function na(t, e) {
        ...
        function nf(t, e, [i,s,n], r, o) {
            !function(t, e=0, i=1, s=.5, n, r=t, o=t) {
                if (ta.test(e) && (e = parseFloat(e),
                e = iO(o.min, o.max, e / 100) - o.min),
                "number" != typeof e)
                    return;
                let a = iO(r.min, r.max, s);
                t === r && (a -= e),
                t.min = nm(t.min, e, i, a, n),
                t.max = nm(t.max, e, i, a, n)
            }(t, e[i], e[s], e[n], e.scale, r, o)
        }
        let nv = ["x", "scaleX", "originX"]
          , ng = ["y", "scaleY", "originY"];
        function ny(t, e, i, s) {
            nf(t.x, e, nv, i ? i.x : void 0, s ? s.x : void 0),
            nf(t.y, e, ng, i ? i.y : void 0, s ? s.y : void 0)
        }
        function nx(t) {
        ...
        function nb(t, e) {
            return nT(t.x, e.x) && nT(t.y, e.y)
        }
        function nS(t) {
            return sC(t.x) / sC(t.y)
        }
        function nA(t, e) {
        ...
        let nM = {
          ...
          , nR = "undefined" != typeof window && void 0 !== window.MotionDebug
          , nk = ["", "X", "Y", "Z"]
          , nD = {
            visibility: "hidden"
        }
        ...
        function nF({attachResizeListener: t, defaultParent: e, measureScroll: i, checkIsScrollRoot: s, resetTransform: n}) {
            return class {
                constructor(t={}, i=null == e ? void 0 : e()) {
                    ...
                    this.updateProjection = () => {
                        this.projectionUpdateScheduled = !1,
                        nR && (nM.totalNodes = nM.resolvedTargetDeltas = nM.recalculatedProjection = 0),
                        this.nodes.forEach(nU),
                        this.nodes.forEach(nH),
                        this.nodes.forEach(nY),
                        this.nodes.forEach(nI),
                        nR && window.MotionDebug.record(nM)
                    }
                    ,
                ...
                addEventListener(t, e) {
                    return this.eventHandlers.has(t) || this.eventHandlers.set(t, new ss),
                ...
                mount(e, i=this.root.hasTreeAnimated) {
                    ...
                    t) {
                        ...
                        t(e, () => {
                            ...
                            s4.hasAnimatedSinceResize && (s4.hasAnimatedSinceResize = !1,
                    ...
                    !1 !== this.options.animate && r && (s || n) && this.addEventListener("didUpdate", ({delta: t, hasLayoutChanged: e, hasRelativeTargetChanged: i, layout: s}) => {
                        ...
                        let n = this.options.transition || r.getDefaultTransition() || nJ
                ...
                willUpdate(t=!0) {
                    ...
                    if (window.HandoffCancelAllAnimations && function t(e) {
                        ...
                        return !!i && (!!sl(i) || !!e.parent && !e.parent.hasCheckedOptimisedAppear && t(e.parent))
                ...
                update() {
                    ...
                    this.clearAllSnapshots();
                    let t = eV.now();
                    tZ.delta = q(0, 1e3 / 60, t - tZ.timestamp),
                    tZ.timestamp = t,
                    tZ.isProcessing = !0,
                    tX.update.process(tZ),
                    tX.preRender.process(tZ),
                    tX.render.process(tZ),
                    tZ.isProcessing = !1
                }
                didUpdate() {
                    this.updateScheduled || (this.updateScheduled = !0,
                    g.read(this.scheduleUpdate))
                }
                clearAllSnapshots() {
                    this.nodes.forEach(n$),
                    this.sharedNodes.forEach(nX)
                }
                ...
                resetTransform() {
                    ...
                    t && (e || sH(this.latestValues) || r) && (n(this.instance, s),
                    this.shouldResetTransform = !1,
                    this.scheduleRender())
                }
                measure(t=!0) {
                ...
                measurePageBox() {
                    ...
                    if (!((null === (t = this.scroll) || void 0 === t ? void 0 : t.wasRoot) || this.path.some(n2))) {
                ...
                removeElementScroll(t) {
                    ...
                    for (let e = 0; e < this.path.length; e++) {
                        ...
                        s !== this.root && n && r.layoutScroll && (n.wasRoot && nc(i, t),
                        sq(i.x, n.offset.x),
                        sq(i.y, n.offset.y))
                    }
                    return i
                ...
                applyTransform(t, e=!1) {
                    ...
                    for (let t = 0; t < this.path.length; t++) {
                        let s = this.path[t];
                        !e && s.options.layoutScroll && s.scroll && s !== s.root && sJ(i, {
                            x: -s.scroll.offset.x,
                            y: -s.scroll.offset.y
                        }),
                        sH(s.latestValues) && sJ(i, s.latestValues)
                    }
                    return sH(this.latestValues) && sJ(i, this.latestValues),
                    i
                }
                removeTransform(t) {
                    let e = s$();
                    ...
                    for (let t = 0; t < this.path.length; t++) {
                        let i = this.path[t];
                        if (!i.instance || !sH(i.latestValues))
                            continue;
                        sK(i.latestValues) && i.updateSnapshot();
                        let s = s$();
                        nc(s, i.measurePageBox()),
                        ny(e, i.latestValues, i.snapshot ? i.snapshot.layoutBox : void 0, s)
                    }
                    return sH(this.latestValues) && ny(e, this.latestValues),
                    e
                }
                setTargetDelta(t) {
                    this.targetDelta = t,
                ...
                forceRelativeParentToResolveTarget() {
                    this.relativeParent && this.relativeParent.resolvedRelativeTargetAt !== tZ.timestamp && this.relativeParent.resolveTargetDelta(!0)
                }
                resolveTargetDelta(t=!1) {
                    ...
                    if (this.layout && (a || l)) {
                        if (this.resolvedRelativeTargetAt = tZ.timestamp,
                        !this.targetDelta && !this.relativeTarget) {
                            ...
                            sD(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox),
                        ...
                        if (this.relativeTarget || this.targetDelta) {
                            ...
                            this.targetWithTransforms = s$()),
                            this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target) ? (this.forceRelativeParentToResolveTarget(),
                            i = this.target,
                            s = this.relativeTarget,
                            n = this.relativeParent.target,
                            sR(i.x, s.x, n.x),
                            sR(i.y, s.y, n.y)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : nc(this.target, this.layout.layoutBox),
                            sG(this.target, this.targetDelta)) : nc(this.target, this.layout.layoutBox),
                            ...
                            nR && nM.resolvedTargetDeltas++
                        }
                    }
                }
                getClosestProjectingParent() {
                    return !this.parent || sK(this.parent.latestValues) || sY(this.parent.latestValues) ? void 0 : this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent()
                }
                isProjecting() {
                ...
                calcProjection() {
                    ...
                    this.resolvedRelativeTargetAt === tZ.timestamp && (s = !1),
                    s)
                        return;
                    ...
                    !function(t, e, i, s=!1) {
                        ...
                        if (o) {
                            ...
                            for (let a = 0; a < o; a++) {
                                ...
                                (!o || !o.props.style || "contents" !== o.props.style.display) && (s && n.options.layoutScroll && n.scroll && n !== n.root && sJ(t, {
                                    x: -n.scroll.offset.x,
                                    y: -n.scroll.offset.y
                                }),
                                r && (e.x *= r.x.scale,
                                e.y *= r.y.scale,
                                sG(t, r)),
                                s && sH(n.latestValues) && sJ(t, n.latestValues))
                            }
                    ...
                    this.projectionDelta && this.prevProjectionDelta ? (np(this.prevProjectionDelta.x, this.projectionDelta.x),
                    np(this.prevProjectionDelta.y, this.projectionDelta.y)) : this.createProjectionDeltas(),
                    sM(this.projectionDelta, this.layoutCorrected, l, this.latestValues),
                    this.treeScale.x === o && this.treeScale.y === a && nA(this.projectionDelta.x, this.prevProjectionDelta.x) && nA(this.projectionDelta.y, this.prevProjectionDelta.y) || (this.hasProjected = !0,
                    this.scheduleRender(),
                    this.notifyListeners("projectionUpdate", l)),
                    nR && nM.recalculatedProjection++
                }
                hide() {
                    this.isVisible = !1
                }
                ...
                setAnimationOrigin(t, e=!1) {
                    ...
                    let a = s$()
                      ...
                      , d = !!(l && !u && !0 === this.options.crossfade && !this.path.some(n_));
                    this.animationProgress = 0,
                    this.mixTargetDelta = e => {
                        ...
                        this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout) {
                            var h, c, p, m;
                            sD(a, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
                        ...
                        function(t, e, i, s, n, r) {
                            n ? (t.opacity = iO(0, void 0 !== i.opacity ? i.opacity : 1, nl(s)),
                            t.opacityExit = iO(void 0 !== e.opacity ? e.opacity : 1, 0, nh(s))) : r && (t.opacity = iO(void 0 !== e.opacity ? e.opacity : 1, void 0 !== i.opacity ? i.opacity : 1, s));
                            for (let n = 0; n < nn; n++) {
                                let r = `border${ns[n]}Radius`
                                  , o = na(e, r)
                                  , a = na(i, r);
                                (void 0 !== o || void 0 !== a) && (o || (o = 0),
                                a || (a = 0),
                                0 === o || 0 === a || no(o) === no(a) ? (t[r] = Math.max(iO(nr(o), nr(a), s), 0),
                                (ta.test(a) || ta.test(o)) && (t[r] += "%")) : t[r] = a)
                            }
                            (e.rotate || i.rotate) && (t.rotate = iO(e.rotate || 0, i.rotate || 0, s))
                ...
                startAnimation(t) {
                    ...
                    this.pendingAnimation && (tY(this.pendingAnimation),
                    this.pendingAnimation = void 0),
                    this.pendingAnimation = tH.update( () => {
                        s4.hasAnimatedSinceResize = !0,
                        this.currentAnimation = function(t, e, i) {
                            let s = W(0) ? 0 : sa(0);
                            return s.start(si("", s, 1e3, i)),
                            s.animation
                        }(0, 0, {
                            ...t,
                            onUpdate: e => {
                ...
                applyTransformsToTarget() {
                    ...
                    if (e && i && s) {
                        if (this !== t && this.layout && s && n5(this.options.animationType, this.layout.layoutBox, s.layoutBox)) {
                            i = this.target || s$();
                            let e = sC(this.layout.layoutBox.x);
                            i.x.min = t.target.x.min,
                            i.x.max = i.x.min + e;
                            let s = sC(this.layout.layoutBox.y);
                            i.y.min = t.target.y.min,
                            i.y.max = i.y.min + s
                        }
                        nc(e, i),
                        sJ(e, n),
                        sM(this.projectionDeltaWithTransform, this.layoutCorrected, e, n)
                    }
                }
                registerSharedNode(t, e) {
                    this.sharedNodes.has(t) || this.sharedNodes.set(t, new nV),
                ...
                resetSkewAndRotation() {
                    ...
                    for (let e = 0; e < nk.length; e++)
                        nL(`rotate${nk[e]}`, t, s, this.animationValues),
                        nL(`skew${nk[e]}`, t, s, this.animationValues);
                ...
                getProjectionStyles(t) {
                    ...
                    if (this.needsReset)
                        ...
                        s.opacity = "",
                        s.pointerEvents = tO(null == t ? void 0 : t.pointerEvents) || "",
                    ...
                    if (!this.projectionDelta || !this.layout || !r.target) {
                        ...
                        e.pointerEvents = tO(null == t ? void 0 : t.pointerEvents) || ""),
                        this.hasProjected && !sH(this.latestValues) && (e.transform = n ? n({}, "") : "none",
                        this.hasProjected = !1),
                        e
                    }
                    ...
                    return this.options.layoutId && (s.pointerEvents = r === this ? tO(null == t ? void 0 : t.pointerEvents) || "" : "none"),
                    s
                }
                clearSnapshot() {
        ...
        function nO(t) {
            ...
            if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
                ...
                sM(o, e, i.layoutBox);
                let a = sU();
                r ? sM(a, t.applyTransform(s, !0), i.measuredBox) : sM(a, e, i.layoutBox);
                let l = !nP(o)
                  , h = !1;
                if (!t.resumeFrom) {
        ...
        function nG(t, e, i) {
            t.translate = iO(e.translate, 0, i),
            t.scale = iO(e.scale, 1, i),
            t.origin = e.origin,
            t.originPoint = e.originPoint
        }
        function nq(t, e, i, s) {
            t.min = iO(e.min, i.min, s),
            t.max = iO(e.max, i.max, s)
        }
        function n_(t) {
        ...
        let nJ = {
          ...
          , nQ = t => "undefined" != typeof navigator && navigator.userAgent && navigator.userAgent.toLowerCase().includes(t)
          , n0 = nQ("applewebkit/") && !nQ("chrome/") ? Math.round : tK.Z;
        function n1(t) {
            t.min = n0(t.min),
            t.max = n0(t.max)
        }
        function n5(t, e, i) {
            return "position" === t || "preserve-aspect" === t && !(.2 >= Math.abs(nS(e) - nS(i)))
        }
        function n2(t) {
            var e;
        ...
        let n3 = nF({
            attachResizeListener: (t, e) => t_(t, "resize", e),
            measureScroll: () => ({
        ...
        class rn {
            ...
            constructor({parent: t, props: e, presenceContext: i, reducedMotionConfig: s, blockInitialAnimation: n, visualState: r}, o={}) {
                ...
                this.resolveKeyframes = (t, e, i, s) => new this.KeyframeResolver(t,e,i,s,this),
                this.current = null,
                this.children = new Set,
            ...
            mount(t) {
                ...
                this.shouldReduceMotion = "never" !== this.reducedMotionConfig && ("always" === this.reducedMotionConfig || n4.current),
                this.parent && this.parent.children.add(this),
            ...
            getValue(t, e) {
                ...
                let i = this.values.get(t);
                return void 0 === i && void 0 !== e && (i = sa(null === e ? void 0 : e, {
                    owner: this
                }),
                this.addValue(t, i)),
                i
            ...
            readValue(t, e) {
                ...
                return null != s && ("string" == typeof s && (eM(s) || eC(s)) ? s = parseFloat(s) : !re(s) && e6.test(e) && (s = io(t, e)),
            ...
            getBaseTarget(t) {
                ...
                if ("string" == typeof s || "object" == typeof s) {
                    let n = tD(this.props, s, null === (e = this.presenceContext) || void 0 === e ? void 0 : e.custom);
                    n && (i = n[t])
                }
                if (s && void 0 !== i)
                    return i;
            ...
            on(t, e) {
                return this.events[t] || (this.events[t] = new ss),
                this.events[t].add(e)
            }
            notify(t, ...e) {
            ...
            readValueFromInstance(t, e) {
                ...
                }
                {
                    let i = window.getComputedStyle(t)
                      , s = (H(e) ? i.getPropertyValue(e) : i[e]) || 0;
        ...
        class ra extends rr {
            ...
            build(t, e, i) {
                tb(t, e, this.isSVGTag, i.transformTemplate)
            }
            renderInstance(t, e, i, s) {
                tE(t, e, i, s)
            }
            mount(t) {
                this.isSVGTag = tA(t.tagName),
                super.mount(t)
            }
        }
        let rl = (t, e) => B(t) ? new ra(e) : new ro(e,{
          ...
          , ru = function(t) {
                ...
                return function({preloadedFeatures: t, createVisualElement: e, useRender: i, useVisualState: s, Component: n}) {
                    ...
                    o.forwardRef)(function(t, c) {
                        ...
                        if (!y && D.j) {
                            ...
                            f = t.MeasureLayout,
                            S.visualElement = function(t, e, i, s, n) {
                                ...
                                let y = v.current
                                  , b = (0,
                                o.useContext)(P);
                                y && !y.projection && n && ("html" === y.type || "svg" === y.type) && function(t, e, i, s) {
                                ...
                                y
                            }(n, A, v, e, t.ProjectionNode)
                        }
                        return (0,
                        r.jsxs)(l.Provider, {
                            value: S,
                            children: [f && S.visualElement ? (0,
                            r.jsx)(f, {
                                visualElement: S.visualElement,
                                ...v
                            }) : null, i(n, t, (m = S.visualElement,
                            (0,
                            o.useCallback)(t => {
                                t && A.mount && A.mount(t),
                                m && (t ? m.mount(t) : m.unmount()),
                                c && ("function" == typeof c ? c(t) : x(c) && (c.current = t))
                            }
                            , [m])), A, y, S.visualElement)]
                        })
                    });
                    return c[L] = n,
                    c
            ...
            let i = new Map;
            return new Proxy(e,{
                get: (t, s) => (i.has(s) || i.set(s, e(s)),
                i.get(s))
            })
        }( (t, e) => (function(t, {forwardMotionProps: e=!1}, i, s) {
            return {
                ...B(t) ? tG : tq,
                preloadedFeatures: i,
                useRender: function(t=!1) {
                    return (e, i, s, {latestValues: n}, r) => {
                        let a = (B(e) ? function(t, e, i, s) {
                            let n = (0,
                            o.useMemo)( () => {
                                let i = tS();
                                return tb(i, e, tA(s), t.transformTemplate),
                                {
                                    ...i.attrs,
                                    style: {
                                        ...i.style
                        ...
                        : function(t, e) {
                          ...
                          , l = function(t, e, i) {
                            let s = {};
                            for (let n in t)
                                ("values" !== n || "object" != typeof t.values) && (tx(n) || !0 === i && ty(n) || !e && !ty(n) || t.draggable && n.startsWith("onDrag")) && (s[n] = t[n]);
                            return s
                        }(i, "string" == typeof e, t)
                          , h = e !== o.Fragment ? {
                            ...l,
